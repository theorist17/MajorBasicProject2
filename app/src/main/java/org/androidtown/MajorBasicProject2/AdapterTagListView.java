...
public class AdapterTagListView extends BaseAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<ItemTag> tags = new ArrayList<ItemTag>() ;

    // ListViewAdapter의 생성자
    public AdapterTagListView() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_tagview, parent, false);
        }
        ...
        // Data Set(tags)에서 position에 위치한 데이터 참조 획득
        ItemTag tag = this.tags.get(position);
    ...
    public void addItem(String value, String tag) {
        ItemTag item = new ItemTag(tag, value);
        tags.add(item);
    }
