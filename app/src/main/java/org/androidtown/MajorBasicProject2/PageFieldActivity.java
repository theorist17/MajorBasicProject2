...
public class PageFieldActivity extends ExpandableListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //Load data
        HandlerDB download_field_brand = new HandlerDB("download_field.php");
        ...
        download_field_brand.setDbResponse(new HandlerDB.DBResponse() {
            ...
            public void onResepones(ArrayList<HashMap<String, String>> dbResult, String log) {
                if(log.equals("json"))
                    ...
                    Toast.makeText(PageFieldActivity.this, log, Toast.LENGTH_SHORT).show();
            }
        });
    }
